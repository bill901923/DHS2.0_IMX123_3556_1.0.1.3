...
else ifeq ($(CONFIG_SNS0_IMX123), y)
CFG_SENSOR_TYPE0 := imx123
KCONFIG_CFLAGS   += -DCONFIG_SNS0_IMX123
...
else ifeq ($(CONFIG_SNS0_AHD_MIPI), y)
CFG_SENSOR_TYPE0 := ahd
KCONFIG_CFLAGS   += -DCONFIG_SNS0_AHD_MIPI
else
...
ifeq ($(CONFIG_SNS0_SERDES), y)
KCONFIG_CFLAGS   += -DCONFIG_SNS0_SERDES
endif

ifeq ($(CONFIG_SNS1_SERDES), y)
KCONFIG_CFLAGS   += -DCONFIG_SNS1_SERDES
endif
...
KCONFIG_CFLAGS   += -DCONFIG_SCREEN_ILI9342C_RGB16BIT
KCONFIG_CFLAGS   += -DCONFIG_SCREEN_TYPE_LCD16BIT
...
ifeq ($(CONFIG_AHD_NVP6324),y)
KCONFIG_CFLAGS   += -DCONFIG_AHD_NVP6324
endif
...
KCONFIG_CFLAGS   += -DCONFIG_APPFS_FAT32
KCONFIG_CFLAGS   += -DCONFIG_APPFS_FAT32_PARTSIZE=$(CONFIG_APPFS_FAT32_PARTSIZE)
CFG_APPFS_TYPE   := fat32
endif
...
ifneq ($(CONFIG_MEM_RES_BASE),)
KCONFIG_CFLAGS   += -DCFG_MEM_RES_BASE=$(CONFIG_MEM_RES_BASE)
endif
ifneq ($(CONFIG_MEM_RES_SIZE),)
KCONFIG_CFLAGS   += -DCFG_MEM_RES_SIZE=$(CONFIG_MEM_RES_SIZE)
endif
...
KCONFIG_CFLAGS   += -DTIME_STAMP_BASE_ADDR_LITEOS=$(shell awk 'BEGIN{printf("0x%x",'$(CONFIG_MEM_PARAM_BASE)'+'$(CONFIG_MEM_PARAM_SIZE)'-0x10000)}')
KCONFIG_CFLAGS   += -DTIME_STAMP_BASE_ADDR_LINUX=$(shell awk 'BEGIN{printf("0x%x",'$(CONFIG_MEM_PARAM_BASE)'+'$(CONFIG_MEM_PARAM_SIZE)'-0x10000+0x1000)}')
...
ifeq ($(CONFIG_SUPPORT_CUSTOM_BACKUP_FILE), y)
KCONFIG_CFLAGS   += -DSUPPORT_CUSTOM_BACKUP_FILE
endif
ifeq ($(CONFIG_SUPPORT_FILE_MARKER), y)
KCONFIG_CFLAGS   += -DSUPPORT_FILE_MARKER
endif
