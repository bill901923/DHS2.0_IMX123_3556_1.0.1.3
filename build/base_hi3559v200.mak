...
KCONFIG_CFLAGS   += -DTIMER_REG_BASE=0x12001000
KCONFIG_CFLAGS   += -DSC_CTRL=0x12020000
...
OSDRV_COMPILE_OPT     := CHIP=$(CFG_SUBCHIP_TYPE) BOOT_MEDIA=$(BOOT_MEDIA) IRQ_BIND=liteos OSDRV_CROSS=$(LINUX_CROSS)
else
...
PQT_PATH              := $(PQT_ROOT)/Hi3559V200_PQ_V1.0.1.3
