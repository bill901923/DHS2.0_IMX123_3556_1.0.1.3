...
ifeq ($(CONFIG_HI3519AV100)$(CONFIG_HI3556AV100), y)
KCONFIG_CFLAGS       += -DVO_CHN_ASPECTRATIO_SUPPORT
endif
...
NDK_COMPILE_OPT            += CFG_SENSOR_TYPE0=IMX123
...
NDK_COMPILE_OPT            += CFG_SENSOR_TYPE0=AHD
else
...
NDK_COMPILE_OPT            += CFG_SENSOR_TYPE1=AHD
else
...
# Compile Option: serdes
ifeq ($(CONFIG_SNS0_SERDES), y)
NDK_COMPILE_OPT            += CFG_SUPPORT_SERDES=y
else ifeq ($(CONFIG_SNS1_SERDES), y)
NDK_COMPILE_OPT            += CFG_SUPPORT_SERDES=y
else
NDK_COMPILE_OPT            += CFG_SUPPORT_SERDES=n
endif
...
ifeq ($(CONFIG_SVP_BIND_HUAWEILITE), y)
NDK_COMPILE_OPT            += CFG_SUPPORT_IVE=y
else
NDK_COMPILE_OPT            += CFG_SUPPORT_IVE=n
endif
...
ifeq ($(MIPI_RX_LANE_DIVIDE_MODE), LANE_DIVIDE_MODE_0)
KCONFIG_CFLAGS       += -DLANE_MODE_0
else ifeq ($(MIPI_RX_LANE_DIVIDE_MODE), LANE_DIVIDE_MODE_1)
KCONFIG_CFLAGS       += -DLANE_MODE_1
endif
ifeq ($(CONFIG_SVP_BIND_HUAWEILITE), y)
KCONFIG_CFLAGS       += -DSVP_BIND_LITEOS
endif
