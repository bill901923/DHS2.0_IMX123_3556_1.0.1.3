                        ...
                        HI_HANDLE hACapHdl, HI_HANDLE hAEncHdl)
{
    ...
    stSensorAttr.stInputDevAttr.inputDataType = DATA_TYPE_RAW_10BIT;
    stSensorAttr.stInputDevAttr.inputMode = INPUT_MODE_MIPI;
    ...
    stVcapAttr.stVcapDevAttr.stWDRAttr.enWDRMode = WDR_MODE_NONE;
    ...
    stVcapAttr.stVcapDevAttr.enIntfMode = VI_MODE_MIPI;
    stVcapAttr.stVcapDevAttr.enInputDataType = VI_DATA_TYPE_RGB;
    stVcapAttr.stVcapDevAttr.au32ComponentMask[0] = 0xFFC00000;
    stVcapAttr.stVcapDevAttr.au32ComponentMask[1] = 0;
    //pipe attr
    ...
    /*vcap*/
    if (HI_MAPI_VCAP_InitSensor(VcapDev0, &stSensorAttr, HI_TRUE) != HI_SUCCESS)
    {
    ...
    if (HI_MAPI_VCAP_InitISP(VcapPipe0) != HI_SUCCESS)
    {
        printf("call HI_MAPI_VCAP_InitISP fail\n");
        goto ISP_STOP;
    }

    if (HI_MAPI_VCAP_StartPipe(VcapPipe0) != HI_SUCCESS)
    {
        printf("call HI_MAPI_VCAP_StartPipe fail\n");
        goto ISP_STOP;
    }

    if (HI_MAPI_VCAP_StartISP(VcapPipe0) != HI_SUCCESS)
    {
        printf("call HI_MAPI_VCAP_StartISP fail\n");
        goto ISP_STOP;
    }
    ...
    stACapAttr.enSoundMode = AUDIO_SOUND_MODE_MONO;
    ...
    if (HI_MAPI_ACAP_Start(hACapHdl, hACapChnHdl) != HI_SUCCESS)
    {
                          ...
                          HI_HANDLE hACapHdl, HI_HANDLE hAEncHdl)
{
    ...
    HI_MAPI_VCAP_StopISP(VcapPipe0);
    HI_MAPI_VCAP_StopPipe(VcapPipe0);
    HI_MAPI_VCAP_DeInitISP(VcapPipe0);
    HI_MAPI_VCAP_StopChn(VcapPipe0, PipeChn0);
    HI_MAPI_VCAP_StopDev(VcapDev0);
    HI_MAPI_VCAP_DeinitSensor(VcapDev0);
    HI_MAPI_Media_Deinit();
