...
static char* sensor_type0 = "imx123"; /* imx123 imx327  imx290 imx377  */
...
HI_VOID Load_sdk(void)
{
    ...
    /*
       PERL_CRG40: for config media module frequency
       to fix the problem that venc only have 4k@20 frame rate
    */
    himm(0x120100a0, 0x182001);
