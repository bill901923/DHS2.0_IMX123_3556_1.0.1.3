...
HI_S32 HI_MAPI_VCAP_RegAhdModule(HI_HANDLE VcapDevHdl, HI_HAL_AHD_DEV_S *pstHalDev)
{
    ...
    MAPI_GLOB_DEV_ATTR_S *pstDevAtr = MAPI_VCAP_GetDevAttr(VcapDevHdl);
    ...
    s32Ret = memcpy_s(pstAhdInfo, sizeof(HI_HAL_AHD_DEV_S), pstHalDev, sizeof(HI_HAL_AHD_DEV_S));
...
HI_S32 HI_MAPI_VCAP_AhdChangeChn(HI_HANDLE VcapDevHdl, HI_BOOL aszChn[], HI_U32 u32Cnt)
{
    ...
    CHECK_MAPI_VCAP_HANDLE_RET("VcapDevHdl", VcapDevHdl, (HI_MAPI_VCAP_MAX_DEV_NUM - 1));
    CHECK_MAPI_VCAP_NULL_PTR_RET(aszChn);
...
{
    CHECK_MAPI_VCAP_HANDLE_RET("VcapDevHdl", VcapDevHdl, (HI_MAPI_VCAP_MAX_DEV_NUM - 1));
    CHECK_MAPI_VCAP_NULL_PTR_RET(astAhdStatus);
...
HI_S32 HI_MAPI_VCAP_UnRegAhdModule(HI_HANDLE VcapDevHdl)
{
    ...
    s32Ret = memcpy_s(pstAhdInfo, sizeof(HI_HAL_AHD_DEV_S), 0, sizeof(HI_HAL_AHD_DEV_S));
    MAPI_CHECK_RET(HI_MAPI_MOD_VCAP, "memcpy_s", s32Ret);
    return HI_SUCCESS;
}
