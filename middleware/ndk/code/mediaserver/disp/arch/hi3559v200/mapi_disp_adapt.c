...
HI_S32 HAL_MAPI_DISP_SetWindowAspectRatioAttr(HI_HANDLE DispHdl, HI_HANDLE WndHdl,
                                          const HI_MAPI_DISP_WINDOW_ASPECTRATIO_S *pstAspectRatioAttr)
{
    ...
    DISP_CHECK_NULL_PTR_RET(pstAspectRatioAttr);
...
HI_S32 HAL_MAPI_DISP_GetWindowAspectRatioAttr(HI_HANDLE DispHdl, HI_HANDLE WndHdl,
                                          HI_MAPI_DISP_WINDOW_ASPECTRATIO_S *pstAspectRatioAttr)
{
    HI_S32 s32Ret;
    VO_LAYER_PARAM_S stLayerParam;
    s32Ret = memset_s(&stLayerParam,  sizeof(VO_LAYER_PARAM_S), 0x0, sizeof(VO_LAYER_PARAM_S));
    MAPI_CHECK_RET(HI_MAPI_MOD_DISP, "memset_s", s32Ret);
