...
HI_S32 OpenAACEncoder(HI_VOID *pEncoderAttr, HI_VOID **ppEncoder)
{
    ...
    s32Ret = memset_s(pstEncoder, sizeof(AENC_AAC_ENCODER_S), 0, sizeof(AENC_AAC_ENCODER_S));
    ...
    *ppEncoder = (HI_VOID *)pstEncoder;
    ...
    s32Ret = memcpy_s(&pstEncoder->stAACAttr, sizeof(HI_MAPI_AENC_ATTR_AAC_S), pstAttr,
        sizeof(HI_MAPI_AENC_ATTR_AAC_S));
...
{
    CHECK_MAPI_AENC_NULL_PTR_RET(pstAacEncoder);
