...
static HI_S32 MSG_AO_Init(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
...
static HI_S32 MSG_AO_Deinit(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AO_Start(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    HI_HANDLE AoChnID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    AoChnID = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg;

    s32Ret = HI_MAPI_AO_Start(AoID, AoChnID);
    if (s32Ret != HI_SUCCESS) {
...
static HI_S32 MSG_AO_Stop(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    HI_HANDLE AoChnID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    ...
    s32Ret = HI_MAPI_AO_Stop(AoID, AoChnID);
    if (s32Ret != HI_SUCCESS) {
...
static HI_S32 MSG_AO_BindAdec(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAoID;
    HI_HANDLE hAoChnID;
    hAoID = GET_DEV_ID(pstMsg->u32Module);
    hAoChnID = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg;

    s32Ret = HI_MAPI_AO_BindAdec(hAoID, hAoChnID, *(HI_HANDLE *)(pstMsg->pBody));
    if (s32Ret != HI_SUCCESS) {
        MAPI_ERR_TRACE(HI_MAPI_MOD_AO, "HI_MAPI_AO_BindAdec fail: %#x\n", s32Ret);
    }
...
static HI_S32 MSG_AO_UnbindAdec(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAoID;
    HI_HANDLE hAoChnID;
    hAoID = GET_DEV_ID(pstMsg->u32Module);
    ...
    s32Ret = HI_MAPI_AO_UnbindAdec(hAoID, hAoChnID, *(HI_HANDLE *)(pstMsg->pBody));
    if (s32Ret != HI_SUCCESS) {
        MAPI_ERR_TRACE(HI_MAPI_MOD_AO, "HI_MAPI_AO_UnbindAdec fail: %#x\n", s32Ret);
    }
...
static HI_S32 MSG_AO_SetVolume(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AO_GetVolume(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AO_Mute(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AO_Unmute(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AO_SendFrame(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    HI_HANDLE AoChnID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    ...
    s32Ret = HI_MAPI_AO_SendFrame(AoID, AoChnID, &pstMsgAFrm->stAFrm, pstMsgAFrm->u32Timeout);
    if (s32Ret != HI_SUCCESS) {
...
static HI_S32 MSG_AO_SendSysFrame(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AoID;
    AoID = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static MSG_MODULE_CMD_S g_stModuleCmdTable[] = {
    ...
    { MSG_CMD_AO_BIND_ADEC,      MSG_AO_BindAdec },
    { MSG_CMD_AO_UNBIND_ADEC,    MSG_AO_UnbindAdec },
