...
static HI_S32 MSG_VCAP_InitSensor(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    ...
    s32Ret = HI_MAPI_VCAP_InitSensor(VcapDevHdl, (HI_MAPI_SENSOR_ATTR_S *)pstMsg->pBody, (HI_BOOL)pstMsg->as32PrivData[0]);
...
static HI_S32 MSG_VCAP_DeinitSensor(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetSensorAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetSensorFrameRate(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetSensorFrameRate(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetSensorModesCnt(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetSensorAllModes(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_StartDev(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_StopDev(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetPipeVCNumber(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    ...
    s32Ret = HI_MAPI_VCAP_SetPipeVCNumber(VcapPipeHdl, (HI_U32)pstMsg->as32PrivData[0]);
...
static HI_S32 MSG_VCAP_GetPipeVCNumber(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
    ...
    s32Ret = HI_MAPI_VCAP_GetPipeVCNumber(VcapPipeHdl, (HI_U32 *)pstMsg->pBody);

    if (s32Ret != HI_SUCCESS) {
        MAPI_ERR_TRACE(HI_MAPI_MOD_VCAP, "Failed : %#x!\n", s32Ret);
    }

    respMsg = HI_IPCMSG_CreateRespMessage(pstMsg, s32Ret, pstMsg->pBody, sizeof(HI_U32));
    CHECK_MAPI_VCAP_NULL_PTR_RET(respMsg);
...
static HI_S32 MSG_VCAP_StartPipe(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
    ...
    s32Ret = HI_MAPI_VCAP_StartPipe(VcapPipeHdl);
...
static HI_S32 MSG_VCAP_StopPipe(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
    ...
    s32Ret = HI_MAPI_VCAP_StopPipe(VcapPipeHdl);
...
static HI_S32 MSG_VCAP_StartChn(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
...
static HI_S32 MSG_VCAP_StopChn(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_InitISP(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
    ...
    s32Ret = HI_MAPI_VCAP_InitISP(VcapPipeHdl);
...
static HI_S32 MSG_VCAP_DeInitISP(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
    ...
    s32Ret = HI_MAPI_VCAP_DeInitISP(VcapPipeHdl);
...
static HI_S32 MSG_VCAP_StartISP(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_StopISP(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetSnapAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetSnapAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_StartTrigger(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_StopTrigger(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetStitchAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
...
static HI_S32 MSG_VCAP_GetStitchAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapStitchHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_StitchTrigger(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapStitchHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetExifInfo(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetExifInfo(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetAttrEx(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_GetAttrEx(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_SetChnCropAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_GetChnCropAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_SetDumpRawAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetDumpRawAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetRawFrame(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32DataNum = 0;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_ReleaseRawFrame(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetChnOSDAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_HANDLE OSDHdl;
...
static HI_S32 MSG_VCAP_GetChnOSDAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_HANDLE OSDHdl;
...
static HI_S32 MSG_VCAP_StartChnOSD(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_HANDLE OSDHdl;
...
static HI_S32 MSG_VCAP_StopChnOSD(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_HANDLE OSDHdl;
...
static HI_S32 MSG_VCAP_SetSnapAttrEx(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetSnapAttrEx(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_SetChnDISAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_GetChnDISAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl;
    HI_HANDLE PipeChnHdl;
    HI_S32 s32Ret;
...
static HI_S32 MSG_VCAP_InitMotionSensor(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_DeInitMotionSensor(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_GetAhdStatus(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
...
static HI_S32 MSG_VCAP_ChangeChn(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapDevHdl;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg = HI_NULL;
