...
static HI_S32 MSG_ACAP_Init(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
...
static HI_S32 MSG_ACAP_Deinit(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_ACAP_SetVol(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_ACAP_GetVol(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_ACAP_Start(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
...
static HI_S32 MSG_ACAP_Stop(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    HI_HANDLE AcapChnHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
...
static HI_S32 MSG_ACAP_EnableVqe(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    HI_HANDLE AcapChnHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
...
static HI_S32 MSG_ACAP_DisableVqe(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    HI_HANDLE AcapChnHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
...
static HI_S32 MSG_ACAP_Mute(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_ACAP_Unmute(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE AcapHdl;
    AcapHdl = GET_DEV_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_ACAP_GetFrame(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    ...
    s32SafeFuncRet = memset_s(&stFrm, sizeof(AUDIO_FRAME_S), 0, sizeof(AUDIO_FRAME_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_AENC, "memset_s", s32SafeFuncRet);
    ...
    s32SafeFuncRet = memcpy_s(&stAcapFrm.stFrm, sizeof(AUDIO_FRAME_S), &stFrm, sizeof(AUDIO_FRAME_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_AENC, "memcpy_s", s32SafeFuncRet);
    s32SafeFuncRet = memcpy_s(&stAcapFrm.stAecFrm, sizeof(AEC_FRAME_S), &stAecFrm, sizeof(AEC_FRAME_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_AENC, "memcpy_s", s32SafeFuncRet);
