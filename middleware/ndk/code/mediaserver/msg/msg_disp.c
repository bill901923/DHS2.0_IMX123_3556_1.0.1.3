...
static HI_S32 MSG_DISP_BindVproc(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE DevID;
    HI_HANDLE ChnID;
    HI_HANDLE GrpHdl;
...
static HI_S32 MSG_DISP_UnbindVproc(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE DevID;
    HI_HANDLE ChnID;
    HI_HANDLE GrpHdl;
...
static HI_S32 MSG_DISP_BindVcap(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE DevID;
    HI_HANDLE ChnID;
...
static HI_S32 MSG_DISP_UnbindVcap(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE DevID;
    HI_HANDLE ChnID;
    HI_HANDLE VcapPipeHdl;
...
static MSG_MODULE_CMD_S g_stModuleCmdTable[] = {
    ...
    { MSG_CMD_DISP_BIND_VPROC,          MSG_DISP_BindVproc },
    { MSG_CMD_DISP_UNBIND_VPROC,        MSG_DISP_UnbindVproc },
    { MSG_CMD_DISP_BIND_VCAP,           MSG_DISP_BindVcap },
    { MSG_CMD_DISP_UNBIND_VCAP,         MSG_DISP_UnbindVcap },
};

MSG_SERVER_MODULE_S g_stModuleDisp = {
    HI_MAPI_MOD_DISP,
    "disp",
