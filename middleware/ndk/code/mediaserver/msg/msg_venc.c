...
static HI_S32 MSG_VENC_Init(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    ...
    s32Ret = memset_s(&stVEncDatafifo, sizeof(MAPI_VENC_DATAFIFO_S), 0x0, sizeof(MAPI_VENC_DATAFIFO_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_VENC, "memset_s", s32Ret);
...
static HI_S32 MSG_VENC_OpenDatafifoStatus(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
...
static HI_S32 MSG_VENC_Deinit(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_VENC_Start(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
    ...
    /* Quick start */
    if (g_abLinuxBootStarted[VencHdl] == HI_FALSE && MAPI_VENC_GetLiteBootStatus(VencHdl) == HI_TRUE) {
        s32Ret = HI_SUCCESS;
    } else {
...
static HI_S32 MSG_VENC_StopReady(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret = HI_SUCCESS;
...
static HI_S32 MSG_VENC_Stop(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_VENC_BindVproc(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
...
static HI_S32 MSG_VENC_UnbindVproc(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VProcHdl, VPortHdl;
    VProcHdl = GET_DEV_ID(pstMsg->u32Module);
    VPortHdl = GET_CHN_ID(pstMsg->u32Module);
...
static HI_S32 MSG_VENC_BindVcap(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
...
static HI_S32 MSG_VENC_UnbindVcap(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VcapPipeHdl, PipeChnHdl;
    VcapPipeHdl = GET_DEV_ID(pstMsg->u32Module);
    PipeChnHdl = GET_CHN_ID(pstMsg->u32Module);
...
static HI_S32 MSG_VENC_SetAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_VENC_GetAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
    ...
    s32Ret = memset_s(&stAttr, sizeof(HI_MAPI_VENC_ATTR_S), 0x0, sizeof(HI_MAPI_VENC_ATTR_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_VENC, "memset_s", s32Ret);
...
static HI_S32 MSG_VENC_ReqIDR(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_VENC_SetExtendAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
    ...
    s32Ret = memcpy_s(&enCmd, sizeof(HI_MAPI_VENC_CMD_E), pstMsg->as32PrivData, sizeof(HI_MAPI_VENC_CMD_E));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_VENC, "memcpy_s", s32Ret);
...
static HI_S32 MSG_VENC_GetExtendAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl;
    VencHdl = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_VENC_SetOSDAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
...
static HI_S32 MSG_VENC_GetOSDAttr(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl, OSDHdl;
    VencHdl = GET_DEV_ID(pstMsg->u32Module);
    OSDHdl = GET_CHN_ID(pstMsg->u32Module);
    ...
    s32Ret = memset_s(&stOSDAttr, sizeof(HI_MAPI_OSD_ATTR_S), 0x0, sizeof(HI_MAPI_OSD_ATTR_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_VENC, "memset_s", s32Ret);
...
static HI_S32 MSG_VENC_StartOSD(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl, OSDHdl;
    HI_S32 s32Ret;
    VencHdl = GET_DEV_ID(pstMsg->u32Module);
...
static HI_S32 MSG_VENC_StopOSD(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE VencHdl, OSDHdl;
    HI_S32 s32Ret;
    VencHdl = GET_DEV_ID(pstMsg->u32Module);
