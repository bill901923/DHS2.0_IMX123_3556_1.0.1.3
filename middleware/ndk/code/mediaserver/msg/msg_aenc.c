...
static HI_S32 MSG_AENC_Init(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE ChnId;
    ...
    s32Ret = memcpy_s(&stAencAttr, sizeof(HI_MAPI_AENC_ATTR_S), pstMsg->as32PrivData, sizeof(HI_MAPI_AENC_ATTR_S));
    MAPI_CHECK_PRINT(HI_MAPI_MOD_AENC, "memcpy_s", s32Ret);
...
static HI_S32 MSG_AENC_Deinit(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE ChnId;
    ChnId = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AENC_Start(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE ChnId;
    ChnId = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static HI_S32 MSG_AENC_Stop(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
...
static HI_S32 MSG_AENC_SetMute(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAencHandle;
    hAencHandle = GET_CHN_ID(pstMsg->u32Module);
    HI_BOOL bEnableMute = *(HI_BOOL *)pstMsg->pBody;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg;

    s32Ret = HI_MAPI_AENC_SetMute(hAencHandle, bEnableMute);
    if (s32Ret != HI_SUCCESS) {
        MAPI_ERR_TRACE(HI_MAPI_MOD_AENC, "HI_MAPI_AENC_SetMute fail: %#x\n", s32Ret);
    }
...
static HI_S32 MSG_AENC_GetMute(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAencHandle;
    hAencHandle = GET_CHN_ID(pstMsg->u32Module);
    HI_BOOL bEnableMute = HI_FALSE;
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg;

    s32Ret = HI_MAPI_AENC_GetMute(hAencHandle, &bEnableMute);
    if (s32Ret != HI_SUCCESS) {
        MAPI_ERR_TRACE(HI_MAPI_MOD_AENC, "HI_MAPI_AENC_SetMute fail: %#x\n", s32Ret);
    }


    respMsg = HI_IPCMSG_CreateRespMessage(pstMsg, s32Ret, &bEnableMute, sizeof(HI_BOOL));
    if (respMsg == HI_NULL) {
        MAPI_ERR_TRACE(HI_MAPI_MOD_AENC, "HI_IPCMSG_CreateRespMessage fail\n");
    }
...
static HI_S32 MSG_AENC_StopFinish(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAencHandle;
    hAencHandle = GET_CHN_ID(pstMsg->u32Module);
...
static HI_S32 MSG_AENC_BindCap(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAencHandle;
...
static HI_S32 MSG_AENC_UnbindCap(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE hAencHandle;
    HI_HANDLE hAcapChnHandle;
    hAencHandle = GET_CHN_ID(pstMsg->u32Module);
...
static HI_S32 MSG_AENC_RegisterEncoder(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg;
...
static HI_S32 MSG_AENC_UnregisterEncoder(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_S32 s32Ret;
    HI_IPCMSG_MESSAGE_S *respMsg;
...
static HI_S32 MSG_AENC_SendFrame(HI_S32 siId, HI_IPCMSG_MESSAGE_S *pstMsg)
{
    HI_HANDLE ChnId;
    ChnId = GET_CHN_ID(pstMsg->u32Module);
    HI_S32 s32Ret;
...
static MSG_MODULE_CMD_S g_stModuleCmdTable[] = {
    ...
    { MSG_CMD_AENC_SET_MUTE,            MSG_AENC_SetMute },
    { MSG_CMD_AENC_GET_MUTE,            MSG_AENC_GetMute },
    { MSG_CMD_AENC_STOP_FINISH,         MSG_AENC_StopFinish },
