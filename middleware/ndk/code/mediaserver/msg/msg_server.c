...
static CMDPROC_FN MSG_SERVER_GetFunc(HI_U32 u32ModID, HI_U32 u32CmdID)
{
    HI_U32 i;
...
static void MediaMsgReceiveProc(HI_S32 siId, HI_IPCMSG_MESSAGE_S *stMsg)
{
    HI_U32 u32ModID;
...
#ifdef SUPPORT_ADEC
    g_msgServerContext.pstServermodules[HI_MAPI_MOD_ADEC] = MAPI_MSG_GetAdecMod();
#endif
