...
HI_S32 HI_MAPI_DISP_Init(HI_HANDLE DispHdl, const HI_MAPI_DISP_ATTR_S *pstDispAttr)
{
    ...
    MAPI_CHECK_RET(HI_MAPI_MOD_DISP, "memcpy_s", s32Ret);
...
HI_S32 HI_MAPI_DISP_Start(HI_HANDLE DispHdl, HI_MAPI_DISP_VIDEOLAYER_ATTR_S *pstVideoLayerAttr)
{
    ...
    DISP_CHECK_HANDLE_RET(DispHdl);
    s32Ret = memcpy_s(&stVideoLayerAttr, sizeof(HI_MAPI_DISP_VIDEOLAYER_ATTR_S), pstVideoLayerAttr,
                                  ...
                                  const HI_MAPI_DISP_WINDOW_ATTR_S *pstWndAttr)
{
    ...
    s32Ret = memcpy_s(&stWndAttr, sizeof(HI_MAPI_DISP_WINDOW_ATTR_S), pstWndAttr, sizeof(HI_MAPI_DISP_WINDOW_ATTR_S));
    MAPI_CHECK_RET(HI_MAPI_MOD_DISP, "memcpy_s", s32Ret);
    ...
    const HI_MAPI_OSD_ATTR_S *pstOsdAttr)
{
    ...
    DISP_CHECK_HANDLE_RET(DispHdl);
    DISP_CHECK_WIN_ID_RET(WndHdl);
    DISP_CHECK_OSD_HANDLE_RET(OsdHdl);
    DISP_CHECK_NULL_PTR_RET(pstOsdAttr);

    s32Ret = memcpy_s(&stOsdAttr, sizeof(HI_MAPI_OSD_ATTR_S), pstOsdAttr, sizeof(HI_MAPI_OSD_ATTR_S));
    MAPI_CHECK_RET(HI_MAPI_MOD_DISP, "memcpy_s", s32Ret);
