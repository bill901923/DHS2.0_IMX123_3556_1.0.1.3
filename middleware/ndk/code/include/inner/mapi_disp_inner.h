...
#define DISP_CHECK_HANDLE_RET(Hdl)                                                                      \
    do {                                                                                                \
...
#define DISP_CHECK_VIDEO_CSC_HANDLE_RET(Hdl)                                                                 \
    do {                                                                                                     \
...
#define DISP_CHECK_GRAPHIC_CSC_HANDLE_RET(Hdl)                                                                 \
    do {                                                                                                       \
...
#define DISP_CHECK_WIN_ID_RET(HdW)                                                                      \
    do {                                                                                                \
...
#define DISP_CHECK_OSD_HANDLE_RET(Hdl)                                                                      \
    do {                                                                                                    \
...
#define DISP_CHECK_VCAPPIPE_HANDLE_RET(Hdl)                                                                 \
    do {                                                                                                    \
...
#define DISP_CHECK_VCAPCHN_HANDLE_RET(Hdl)                                                                 \
    do {                                                                                                   \
...
#define DISP_CHECK_VPSSDVE_HANDLE_RET(Hdl)                                                              \
    do {                                                                                                \
...
#define DISP_CHECK_VPSSVPORT_HANDLE_RET(Hdl)                                                             \
    do {                                                                                                 \
...
#define DISP_CHECK_NULL_PTR_RET(pstPtr)                          \
    do {                                                         \
        if (NULL == (pstPtr)) {                                  \
...
#define DISP_CHECK_INIT_RET(state)                                          \
    do {                                                                    \
        if (!state) {                                                       \
...
#define DISP_CHECK_BIND_RET(state)                                       \
    do {                                                                 \
        if (state) {                                                     \
