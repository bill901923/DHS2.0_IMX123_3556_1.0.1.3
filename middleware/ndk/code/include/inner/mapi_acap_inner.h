...
#define MAPI_ACAP_FRAME_CACHED_CNT   5
#define MAPI_ACAP_FRAME_CACHED_DEPTH 5

#define CHECK_MAPI_ACAP_NULL_PTR_RET(ptr)                            \
    do {                                                             \
        if (NULL == ptr) {                                           \
...
#define CHECK_MAPI_ACAP_HANDLE_RANGE_RET(handle)                            \
    do {                                                                    \
...
#define CHECK_MAPI_ACAP_CHN_HANDLE_RANGE_RET(handle)                            \
    do {                                                                        \
...
#define CHECK_MAPI_ACAP_CHECK_INIT_RET(state)                                                                    \
    do {                                                                                                         \
        if (!state) {                                                                                            \
