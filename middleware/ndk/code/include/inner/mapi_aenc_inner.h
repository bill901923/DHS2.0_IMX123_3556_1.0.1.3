...
#define CHECK_MAPI_AENC_NULL_PTR_RET(ptr)                            \
    do {                                                             \
        if (HI_NULL == ptr) {                                        \
...
#define CHECK_MAPI_AENC_CHECK_INIT_RET(state)                                                                    \
    do {                                                                                                         \
        if (!state) {                                                                                            \
...
#define CHECK_MAPI_AENC_ACAPHANDLE_RANGE_RET(handle)                                                                  \
    do {                                                                                                              \
...
#define CHECK_MAPI_AENC_ACAPCHNHANDLE_RANGE_RET(handle)                                        \
    do {                                                                                       \
...
#define CHECK_MAPI_AENC_HANDLE_RANGE_RET(handle)                                                                      \
    do {                                                                                                              \
...
HI_S32 MAPI_AENC_ClientInit(HI_VOID);
HI_S32 MAPI_AENC_ClientDeinit(HI_VOID);
