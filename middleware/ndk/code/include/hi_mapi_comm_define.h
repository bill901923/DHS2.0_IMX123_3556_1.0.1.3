...
#define HI_MAPI_PHY_VPORT_MAX_NUM (4)
#define HI_MAPI_EXT_VPORT_MAX_NUM (8)
#endif
...
#define HI_MAPI_PHY_VPORT_MAX_NUM (3)
#define HI_MAPI_EXT_VPORT_MAX_NUM (8)
#endif
...
#define HI_MAPI_PHY_VPORT_MAX_NUM (3)
#define HI_MAPI_EXT_VPORT_MAX_NUM (4)
#endif
...
#define HI_MAPI_ADEC_CHN_MAX_NUM  (ADEC_MAX_CHN_NUM / 2)
...
#define HI_MAPI_SYS_ESAFEFUNC_OPERATE_FAIL    \
    HI_MAPI_DEF_ERR(HI_MAPI_MOD_SYS, MAPI_EN_ERR_LEVEL_ERROR, MAPI_EN_ERR_SAFEFUNC_OPERATE_FAIL)
...
/** the param of the isp mod */
typedef struct hiMAPI_ISP_PARAM_MOD_S {
    HI_BOOL bIspSetModPara;
    HI_BOOL bQuickStart;
    HI_BOOL bIntBotHalf;
} HI_MAPI_ISP_PARAM_MOD_S;
...
typedef struct hiHI_MAPI_MEDIA_ATTR_S {
    ...
    HI_MAPI_ISP_PARAM_MOD_S stIspModPara;
