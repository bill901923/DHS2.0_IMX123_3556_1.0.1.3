...
/**
 * @brief Set front sensor or AD VCNumber which is connected to front sensor or AD
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @param[in] u32VCNumber HI_U32:VC Number.
 * @return 0  Set Pipe VCNumber success.
 * @return Non 0 Set Pipe VCNumber fail.
 */
HI_S32 HI_MAPI_VCAP_SetPipeVCNumber(HI_HANDLE VcapPipeHdl, HI_U32 u32VCNumber);

/**
 * @brief Get front sensor or AD VCNumber which is connected to front sensor or AD
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @param[out] pu32VCNumber HI_U32 *:VC Number pointer.
 * @return 0  Get Pipe VCNumber success.
 * @return Non 0 Get Pipe VCNumber fail.
 */
HI_S32 HI_MAPI_VCAP_GetPipeVCNumber(HI_HANDLE VcapPipeHdl, HI_U32 *pu32VCNumber);

/**
 * @brief Start VCAP Pipe
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @return 0  Start VCAP Pipe success.
 * @return Non 0 Start VCAP Pipe fail.
 */
HI_S32 HI_MAPI_VCAP_StartPipe(HI_HANDLE VcapPipeHdl);

/**
 * @brief Stop VCAP Pipe
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @return 0  Stop VCAP Pipe success.
 * @return Non 0 Stop VCAP Pipe fail.
 */
 ...
 * @brief Init VCAP ISP
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @return 0  Init VCAP ISP success.
 * @return Non 0 Init VCAP ISP fail.
 */
HI_S32 HI_MAPI_VCAP_InitISP(HI_HANDLE VcapPipeHdl);

/**
 * @brief deinit VCAP ISP
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @return 0  deinit VCAP ISP success.
 * @return Non 0 deinit VCAP ISP fail.
 */
