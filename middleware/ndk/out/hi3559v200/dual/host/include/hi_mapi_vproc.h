...
/**
 * @brief start receive vcap yuv frame.
 * @param[in] VpssHdl HI_HANDLE : handle of vpss.
 * @param[in] VcapPipeHdl HI_HANDLE:handle of video capture PIPE.
 * @param[in] enYuvSeq VI_YUV_DATA_SEQ_E:the sequence of yuv frame from vcap.
 * @return 0  successful.
 * @return non 0  fail.
 */
...
/**
 * @brief stop receive vcap yuv frame.
 * @param[in] VpssHdl HI_HANDLE : handle of vpss.
 * @return 0  successful.
 * @return non 0  fail.
 */
...
/**
 * @brief Set attribute of an extern port in vpss.
 * @param[in] VpssHdl HI_HANDLE : handle of vpss.
 * @param[in] VPortHdl HI_HANDLE : handle of extern vport.
 * @param[in] pstExtVPortAttr HI_MAPI_EXT_VPORT_ATTR_S*: pointer of extern vport attribute. Dynamic attribute.
 * @return 0  successful.
 * @return non 0  fail.
 */
...
/**
 * @brief Get attribute of an extern port in vpss.
 * @param[in] VpssHdl HI_HANDLE : handle of vpss.
 * @param[in] VPortHdl HI_HANDLE : handle of extern vport.
 * @param[out] pstExtVPortAttr HI_MAPI_EXT_VPORT_ATTR_S*: pointer of extern vport attribute.
 * @return 0  successful.
 * @return non 0  fail.
 */
...
/**
 * @brief Set vproc crop info.
 * @param[in] VpssHdl HI_HANDLE :handle of vpss.
 * @param[in] VPortHdl HI_HANDLE : handle of vport.
 * @param[in] pstCropInfo VPSS_CROP_INFO_S : Crop info pointer.
 * @return 0  successful.
 * @return non 0  fail.
 */
...
/**
 * @brief Get vproc crop info.
 * @param[in] VpssHdl HI_HANDLE :handle of vpss.
 * @param[in] VPortHdl HI_HANDLE : handle of vport.
 * @param[out] pstCropInfo VPSS_CROP_INFO_S : Crop info pointer.
 * @return 0  successful.
 * @return non 0  fail.
 */
