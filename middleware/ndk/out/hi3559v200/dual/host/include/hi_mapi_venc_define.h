...
typedef enum hiMAPI_VENC_RC_MODE_E {
    ...
    HI_MAPI_VENC_RC_MODE_CVBR, /* <constrained variable bit rate */
    HI_MAPI_VENC_RC_MODE_AVBR, /* <Adaptive variable bit rate */
...
typedef struct hiVENC_H264_AVBR_S
    HI_MAPI_VENC_ATTR_AVBR_S; /* <H264,H265 are the same, Data structure reference MPI */
...
typedef struct hiMAPI_VENC_RC_ATTR_S {
    ...
    union {
        ...
        HI_MAPI_VENC_ATTR_CVBR_S stAttrCVbr; /* <attributes of cvbr */
        HI_MAPI_VENC_ATTR_AVBR_S stAttrAVbr; /* <attributes of avbr */
    };
