 ...
 * Description: Definiton of mbuf data structure and error code
...
/* frame which is first or whose prev frame is not key framef */
#define HI_ERR_MBUF_NOTKEYFRAME  (HI_ERR_MBUF_BASE - 10)
