...
static HI_S32 STG_DEV_FSMEventCB(__attribute__((unused)) HI_VOID *pStateMachine, HI_VOID *pPriv, HI_S32 s32Event,
                                 __attribute__((unused)) HI_S32 s32RetVal)
{
...
HI_S32 STG_DEV_Create(const STG_DEV_CFG_S *pstCfg, HI_MW_PTR *ppDev)
{
    ...
    s32Ret = STG_DEVINFO_Create(pstCfg->u8DevPortNo, pstCfg->u8DevErrCountThr, pstCfg->aszPartitionPath,
                                &pstDev->pDevInfo);
