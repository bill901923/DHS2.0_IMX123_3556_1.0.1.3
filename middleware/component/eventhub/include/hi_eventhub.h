 ...
 * Description: Interface declaration of eventHub
...
#define HI_ERR_EVTHUB_HANDLE_INVALID HI_APP_DEF_ERR(HI_APPID_EVTHUB, APP_ERR_LEVEL_ERROR, \
    APP_EVTHUB_ERR_HANDLE_INVALID)
...
#define HI_ERR_EVTHUB_EVENT_NO_RIGEST HI_APP_DEF_ERR(HI_APPID_EVTHUB, APP_ERR_LEVEL_ERROR, \
    APP_EVTHUB_ERR_EVENT_NO_RIGEST)
#define HI_ERR_EVTHUB_NO_EVENT_HISTORY HI_APP_DEF_ERR(HI_APPID_EVTHUB, APP_ERR_LEVEL_ERROR, \
    APP_EVTHUB_ERR_NO_EVENT_HISTORY)
