...
typedef struct hiLITEPLAYER_PARAM_S {
    ...
    HI_U32 u32VdecFrameBufCnt;         /**< Number of VB blocks for storing decoded image frames;if 0,use the inner default value */
...
typedef HI_S32 (*HI_LITEPLAYER_ON_VB_POOL_GET_FN)(HI_VOID *pPlayer, HI_U32 u32FrameBufSize,
                                                  HI_U32 u32FrameBufCnt,
                                                  HI_U32 *pVbPoolId,
                                                  HI_VOID *pPriv);

typedef HI_S32 (*HI_LITEPLAYER_ON_VB_POOL_PUT_FN)(HI_VOID *pPlayer,
                                                  HI_U32 u32VbPoolId,
                                                  HI_VOID *pPriv);
...
*   @retval  0 success,others failed
 */
HI_S32 HI_LITEPLAYER_RegisterDemuxer(const HI_CHAR *dllName,
                                     const HI_LITEPLAYER_EXTRA_FILESURFIX_S *pstExtraFileSurfix);
