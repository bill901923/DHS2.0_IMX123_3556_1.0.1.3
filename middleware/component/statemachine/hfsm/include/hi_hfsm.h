 ...
 * Description: Module external interface statement
...
#define HI_ERR_HFSM_ROOT_STATE_EXIST HI_APP_DEF_ERR(HI_APPID_HFSM, APP_ERR_LEVEL_ERROR, \
    APP_HFSM_ERR_ROOT_STATE_EXIST)
...
#define HI_ERR_HFSM_STATE_EXCEED_MAX_CNT HI_APP_DEF_ERR(HI_APPID_HFSM, APP_ERR_LEVEL_ERROR, \
    APP_HFSM_ERR_STATE_EXCEED_MAX_CNT)
...
typedef struct hiSTATE_S{
    ...
    HI_S32 (*processMessage)(HI_MESSAGE_S *pMsg, HI_MW_PTR argv, HI_STATE_ID *pStateID);
