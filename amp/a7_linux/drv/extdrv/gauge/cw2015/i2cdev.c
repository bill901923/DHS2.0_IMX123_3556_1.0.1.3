...
#endif
#define I2C_NUM 4
#define FST_ADDR 0x62

static struct i2c_board_info hi_info = {
     I2C_BOARD_INFO("i2c-cw2015", FST_ADDR),
};
...
int i2cdev_write(char *buf, unsigned int count,unsigned int reg_addr_num, unsigned int data_byte_num)
{
    int ret;
...
int i2cdev_read(char *buf, unsigned int count,unsigned int reg_addr_num, unsigned int data_byte_num)
{
    int ret;
