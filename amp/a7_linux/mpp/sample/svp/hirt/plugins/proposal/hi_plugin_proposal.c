    ...
    HI_NodePlugin_Operand_S *pstOutputs, HI_U32 u32Outputs, HI_NodePlugin_NodeParam_S* pstHyperParam, HI_NodePlugin_NodeParam_S* pstTrainingParam)
{
    ...
    SAMPLE_CHK_RET(u32InputNum != 2, HI_FAILURE, "proposal inputs number error,the corrent number is %u\n", u32InputNum);
    ...
    SAMPLE_CHK_RET(s32Ret != HI_SUCCESS, HI_FAILURE, "SAMPLE_AllocMem error, return value :%d\n", s32Ret);
...
HI_S32 HI_NodePlugin_getNodeType(HI_CHAR pszNodeType[], const HI_U32 u32Length)
{
    ...
    SAMPLE_CHK_RET((u32Length < sizeof("Proposal")), HI_FAILURE, "param u32Length is too small");
