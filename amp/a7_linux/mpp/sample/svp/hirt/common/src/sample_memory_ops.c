...
HI_S32 SAMPLE_AllocMem(HI_RUNTIME_MEM_S *pstMemInfo, HI_BOOL bCached)
{
    ...
    SAMPLE_CHK_RET((HI_NULL == pstMemInfo), HI_FAILURE, "param pstMemInfo is NULL\n");
...
{
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_CHK_RET((0 == pstMemInfo->u64VirAddr), HI_FAILURE, "param pu8VirAddr is NULL\n");
#ifdef ON_BOARD
    s32Ret = HI_MPI_SYS_MmzFlushCache(pstMemInfo->u64PhyAddr, (HI_VOID*)((uintptr_t)pstMemInfo->u64VirAddr), pstMemInfo->u32Size);
#endif
    return s32Ret;
}
...
HI_S32 SAMPLE_FreeMem(HI_RUNTIME_MEM_S *pstMemInfo)
{
    ...
    SAMPLE_CHK_RET((0 == pstMemInfo->u64VirAddr), HI_FAILURE, "param pu8VirAddr is NULL\n");
#ifdef ON_BOARD
    s32Ret = HI_MPI_SYS_MmzFree(pstMemInfo->u64PhyAddr, (HI_VOID*)((uintptr_t)pstMemInfo->u64VirAddr));
#else
