                         ...
                         HI_S32 as32Coord[], HI_U32 u32CoordCnt, HI_U32 u32CoordStride)
{
    ...
    drawImageRectByIVE(aszFileName, pstBlob, as32Coord, u32CoordCnt, u32CoordStride, sizeof(aszFileName));
    return;
#else
    snprintf(aszFileName, sizeof(aszFileName) - 1, "%s.png", pszPicPath);
    drawImageRectByCV(aszFileName, pstBlob, as32Coord, u32CoordCnt, u32CoordStride, sizeof(aszFileName));
    return;
#endif
}
