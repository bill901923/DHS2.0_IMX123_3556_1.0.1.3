...
combo_dev_attr_t MIPI_4lane_CHN0_SENSOR_IMX123_12BIT_5M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, 2048, 1536},
...
combo_dev_attr_t MIPI_4lane_CHN0_SENSOR_IMX123_10BIT_5M_WDR2TO1_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
combo_dev_attr_t MIPI_4lane_CHN0_SENSOR_IMX123_12BIT_4M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 204, 2048, 1536},
...
combo_dev_attr_t MIPI_4lane_CHN0_SENSOR_IMX123_10BIT_4M_WDR2TO1_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
VI_DEV_ATTR_S DEV_ATTR_IMX123_5M_BASE =
{
    VI_MODE_MIPI,
    VI_WORK_MODE_1Multiplex,
    {0xFFF00000,    0x0},
...
VI_DEV_ATTR_S DEV_ATTR_IMX123_4M_BASE =
{
    VI_MODE_MIPI,
    VI_WORK_MODE_1Multiplex,
    {0xFFF00000,    0x0},
...
static VI_PIPE_ATTR_S PIPE_ATTR_2048x1536_RAW12_420_3DNR_RFR =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE, HI_FALSE,
    2048, 1536,
    PIXEL_FORMAT_RGB_BAYER_12BPP,
...
static VI_PIPE_ATTR_S PIPE_ATTR_2048x1536_RAW10_420_3DNR_RFR =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE, HI_FALSE,
    2048, 1536,
...
static VI_CHN_ATTR_S CHN_ATTR_2048x1536_420_SDR8_LINEAR =
{
    {2048, 1536},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t* pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX123_MIPI_5M_30FPS_12BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_IMX123_12BIT_5M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;

        case SONY_IMX123_MIPI_5M_30FPS_10BIT_WDR2TO1:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_IMX123_10BIT_5M_WDR2TO1_ATTR, sizeof(combo_dev_attr_t));
            break;

        case SONY_IMX123_MIPI_4M_30FPS_12BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_IMX123_12BIT_4M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;

        case SONY_IMX123_MIPI_4M_30FPS_10BIT_WDR2TO1:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_IMX123_10BIT_4M_WDR2TO1_ATTR, sizeof(combo_dev_attr_t));
            break;

        case OMNIVISION_OS04B10_MIPI_4M_30FPS_10BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_OS04B10_10BIT_4M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        ...
        case OMNIVISION_OV12870_MIPI_8M_30FPS_10BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_OV12870_10BIT_8M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        case OMNIVISION_OV12870_MIPI_12M_30FPS_10BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_OV12870_10BIT_12M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        case OMNIVISION_OV12870_MIPI_2M_120FPS_10BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_OV12870_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        case OMNIVISION_OV12870_MIPI_1M_240FPS_10BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_OV12870_10BIT_1M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S* pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX123_MIPI_5M_30FPS_12BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_IMX123_5M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        ...
        case SONY_IMX123_MIPI_4M_30FPS_12BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_IMX123_4M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        ...
        case OMNIVISION_OS04B10_MIPI_4M_30FPS_10BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_OS04B10_4M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S* pstPipeAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX123_MIPI_5M_30FPS_12BIT:
            hi_memcpy(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2048x1536_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;

        case SONY_IMX123_MIPI_5M_30FPS_10BIT_WDR2TO1:
            hi_memcpy(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2048x1536_RAW10_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
        ...
        case OMNIVISION_OS04B10_MIPI_4M_30FPS_10BIT:
            hi_memcpy(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2560x1440_RAW10_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S* pstChnAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX123_MIPI_5M_30FPS_12BIT:
        case SONY_IMX123_MIPI_5M_30FPS_10BIT_WDR2TO1:
            hi_memcpy(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2048x1536_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
        ...
        case OMNIVISION_OS04B10_MIPI_4M_30FPS_10BIT:
            hi_memcpy(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2560x1440_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
