...
void vd_jaguar1_960p_30P_test_set( unsigned char dev, unsigned char ch )
{
    ...
    gpio_i2c_write(jaguar1_i2c_addr[dev], 0xff, 0x00);
	gpio_i2c_write(jaguar1_i2c_addr[dev], 0x68 + ch, 0x94);
    ...
    gpio_i2c_write(jaguar1_i2c_addr[dev], 0x18 + ch, 0x13);
...
{
   unsigned char val_0x00, val_1x97, val_1x98, val_20x00;

   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0xFF, 0x20);
   val_20x00 = gpio_i2c_read(jaguar1_i2c_addr[devnum], 0x00);    //mipi output disable
   val_20x00 &= ~(0x11<<ch);
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x00, val_20x00);

   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0xFF, 0x00);
   val_0x00 = gpio_i2c_read(jaguar1_i2c_addr[devnum], 0x00+ch);
   val_0x00 |= 0x01;
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x00+ch, val_0x00);  //anolog afe disable

   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0xFF, 0x01);
   val_1x97 = gpio_i2c_read(jaguar1_i2c_addr[devnum], 0x97);     //digital clk disable
   val_1x97 &= ~(0x01<<ch);
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x97, val_1x97);

   val_1x98 = gpio_i2c_read(jaguar1_i2c_addr[devnum], 0x98);
   val_1x98 |= (0x01<<ch);
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x98, val_1x98);

   printk("[drv]vd_jaguar1_stop_chnl[%d][%d] complete!!\n", devnum, ch);
}
...
void vd_jaguar1_start_chnl( unsigned char devnum, unsigned char ch)
{
   ...
   val_0x00 = gpio_i2c_read(jaguar1_i2c_addr[devnum], 0x00+ch);
   val_0x00 &= 0xFE;
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x00+ch, val_0x00);  //anolog afe enable

   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0xFF, 0x01);
   val_1x97 = gpio_i2c_read(jaguar1_i2c_addr[devnum], 0x97);     //digital clk enable
   val_1x97 |= (0x01<<ch);
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x97, val_1x97);
   ...
   val_20x00 |= (0x11<<ch);
   gpio_i2c_write(jaguar1_i2c_addr[devnum], 0x00, val_20x00);
   printk("[drv]vd_jaguar1_start_chnl[%d][%d] complete!!\n", devnum, ch);
}
