...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX123_MIPI_5M_30FPS =
{
    {0, 0, 2048, 1536},
    {2048, 1536},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX123_MIPI_5M_30FPS_WDR2TO1 =
{
    {0, 0, 2048, 1536},
    {2048, 1536},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX123_MIPI_4M_30FPS =
{
    {0, 0, 2048, 1536},
    {2048, 1536},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX123_MIPI_4M_30FPS_WDR2TO1 =
{
    {0, 0, 2048, 1536},
    {2048, 1536},
    30,
...
HI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S* pstPubAttr)
{
    switch (enSnsType)
    {
        case SONY_IMX123_MIPI_5M_30FPS_12BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX123_MIPI_5M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case SONY_IMX123_MIPI_4M_30FPS_12BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX123_MIPI_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case SONY_IMX123_MIPI_5M_30FPS_10BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX123_MIPI_5M_30FPS_WDR2TO1, sizeof(ISP_PUB_ATTR_S));
            break;

        case SONY_IMX123_MIPI_4M_30FPS_10BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX123_MIPI_4M_30FPS_WDR2TO1, sizeof(ISP_PUB_ATTR_S));
            break;
