                ...
                PDT_PARAM_MEDIAMODE_COMM_VCAP_DEV_S *pstParam)
{
    ...
    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:antiflicker_value");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 1,(HI_S32*)&pstParam->enAnfilicker);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:input_mode");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->inputMode);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:interface_mode");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->interfaceMode);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:datasequce");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->dataSeq);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:inputdatatype");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->inputDataType);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    MLOGD("vcap dev comm attr  enable[%d],vcapdevhdl[%d] wdr_mode[%d] antiflicker_value[%d]\n",
        pstParam->bEnable,pstParam->VcapDevHdl,pstParam->enWdrMode, pstParam->enAnfilicker);

    MLOGD("vcap dev comm attr  input_mode[%d] interface_mode[%d] datasequce[%d] inputdatatype[%d]\n",
        pstParam->inputMode, pstParam->interfaceMode, pstParam->dataSeq, pstParam->inputDataType);
...
static HI_S32 PDT_INIPARAM_CAM_MEDIA_LoadDispCropCfg(const HI_CHAR *pszIniModule,HI_PDT_MEDIA_DISP_WND_CROP_CFG_S *pstParam)
{
    ...
    MLOGI("   window crop enable[%d] u32MaxH[%d], u32CurH[%d]\n",
                ...
                PDT_PARAM_MEDIAMODE_VCAP_PIPE_ATTR_S *pstParam)
{
    ...
    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s:isp_mirrorflip",szIniNodePrefix);
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->stIspPubAttr.enSnsMirrorFlip);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    MLOGD("isp pub attr, isp_framerate[%f], isp_width[%d], isp_height[%d] isp_mirrorflip[%d]\n",pstParam->stIspPubAttr.f32FrameRate,
        pstParam->stIspPubAttr.stSize.u32Width,pstParam->stIspPubAttr.stSize.u32Height, pstParam->stIspPubAttr.enSnsMirrorFlip);
                ...
                PDT_PARAM_MEDIAMODE_VCAP_DEV_ATTR_S *pstParam)
{
    ...
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->stSnsAttr.stSize.u32Width);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:sensor_height");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->stSnsAttr.stSize.u32Height);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);


    snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s","vcap.dev:data_type");
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->stSnsAttr.stInputDevAttr.inputDataType);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

    MLOGD("vcapdev  sensor attr, sensor_mode[%d],sensor_width[%d],sensor_height[%d],data_type[%d]  \n",
        pstParam->stSnsAttr.u32SnsMode,
        pstParam->stSnsAttr.stSize.u32Width,pstParam->stSnsAttr.stSize.u32Height,
        pstParam->stSnsAttr.stInputDevAttr.inputDataType);
    ...
    for(i = 0; i < VI_COMPMASK_NUM;i++) {
        snprintf(szIniNodeName,PDT_INIPARAM_NODE_NAME_LEN,"%s%u","vcap.dev:componentmask", i);
        s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0,(HI_S32*)&pstParam->stVcapDevAttr.au32ComponentMask[i]);
        PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

        MLOGD("vcap dev attr,componentmask%u[%u] \n", i, pstParam->stVcapDevAttr.au32ComponentMask[i]);
    }
