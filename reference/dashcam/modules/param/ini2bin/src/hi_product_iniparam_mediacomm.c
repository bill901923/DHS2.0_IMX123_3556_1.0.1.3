                ...
                const HI_CHAR *pszPrefix, HI_MAPI_DISP_WINDOW_ATTR_S *pstParam)
{
    ...
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);
    MLOGI("    WndAttr pos[%u,%u], size[%u,%u], priority[%u]\n",
                ...
                HI_PDT_MEDIA_ACAP_CFG_S *pstParam)
{
    ...
    snprintf(szIniNodeName, PDT_INIPARAM_NODE_NAME_LEN, "%s:track_mode", szIniNodePrefix);
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0, (HI_S32*)&pstParam->stAcapAttr.enTrackMode);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);
                ...
                HI_PDT_MEDIA_AO_CFG_S *pstParam)
{
    ...
    snprintf(szIniNodeName, PDT_INIPARAM_NODE_NAME_LEN, "%s:track_mode", szIniNodePrefix);
    s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0, (HI_S32*)&pstParam->stAoAttr.enTrackMode);
    PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);
    ...
    for (chnIdx = 0; chnIdx < HI_PDT_MEDIA_AO_CHN_MAX_CNT; ++chnIdx) {
        snprintf(szIniNodeName, PDT_INIPARAM_NODE_NAME_LEN, "%s.chnl.%d:handle", szIniNodePrefix, chnIdx);
        s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0, (HI_S32*)&pstParam->aoChnCfg[chnIdx].aoChnHdl);
        PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);

        snprintf(szIniNodeName, PDT_INIPARAM_NODE_NAME_LEN, "%s.chnl.%d:enable", szIniNodePrefix, chnIdx);
        s32Ret = HI_CONFACCESS_GetInt(PDT_INIPARAM, pszIniModule, szIniNodeName, 0, (HI_S32*)&pstParam->aoChnCfg[chnIdx].enable);
        PDT_INIPARAM_CHECK_LOAD_RESULT(s32Ret, szIniNodeName);
    }
