...
#define PDT_UI_KEY_POWER     HIGV_KEY_POWER
#define PDT_UI_KEY_LOCK      HIGV_KEY_F4
#define PDT_UI_KEY_BACK      HIGV_KEY_F3
#define PDT_UI_KEY_MENU      HIGV_KEY_F2
#define PDT_UI_KEY_OK        HIGV_KEY_F1
#define PDT_UI_KEY_UP        HIGV_KEY_P2
#define PDT_UI_KEY_DOWN      HIGV_KEY_P1
#else
#define PDT_UI_KEY_EXPAND    HIGV_KEY_F4
#define PDT_UI_KEY_BACK      HIGV_KEY_F3
#define PDT_UI_KEY_MENU      HIGV_KEY_F2
#define PDT_UI_KEY_OK        HIGV_KEY_F1
#define PDT_UI_KEY_UP        PDT_UI_KEY_EXPAND
#define PDT_UI_KEY_DOWN      PDT_UI_KEY_MENU
#define PDT_UI_HOME_KEY_WIFI HIGV_KEY_P1
#endif
#define PDT_UI_UPGRADING_RANGE (100)
...
typedef enum tagPDT_UI_ACTION_E
{
    ...
    PDT_UI_ACTION_SHOW_ANTIFLICKER,
#ifdef CONFIG_MOTIONDETECT_ON
    ...
    PDT_UI_ACTION_SET_ANTIFLICKER = (PDT_UI_ACTION_SHOW_ANTIFLICKER + PDT_UI_SET_AND_SHOW_OFFSET),
...
//by Eason HI_S32 PDT_UI_COMM_CheckSd(HI_VOID);
...
HI_S32 PDT_UI_PLAYBACK_Exit(HI_VOID);
