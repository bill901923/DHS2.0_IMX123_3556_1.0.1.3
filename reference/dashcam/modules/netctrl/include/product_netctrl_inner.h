...
#define PDT_NETCTRL_STORAGE_MAX_ERRCNT 5
...
#define PDT_NETCTRL_PARAM_TYPE_ANTIFLICKER          "ANTIFLICKER"
#define PDT_NETCTRL_PARAM_TYPE_PQTOOL               "PQTOOL"
...
#define PDT_NETCTRL_KEY_EXPAND   "KEY_EXPAND"
...
/**
* @brief     tet Simulatio nEvent Enum
* @param[in] enumStr
* @param[out] simulationEvent
* @return 0 success,non-zero error code.
* @exception    None
* @author    HiMobileCam Reference Develop Team
* @date      2019/6/26
