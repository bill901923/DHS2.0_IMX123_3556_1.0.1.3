...
static HI_S32 PDT_STATEMNG_InitStates(HI_VOID)
{
    ...
    PDT_STATEMNG_CONTEXT *pstStateMngCtx = PDT_STATEMNG_GetCtx();
        ...
        MLOGD(RED"PDT_STATEMNG_InitStates\n\n"NONE);
...
HI_S32 HI_PDT_STATEMNG_Init(const HI_PDT_STATEMNG_CONFIG_S* pstStatemngCfg)
{
    ...
    MLOGI(RED"PDT_STATEMNG_ContextInit\n\n"NONE);
    ...
    /** create HFSM instance */
    MLOGI(RED"PDT_STATEMNG_CreateHFSMInstance\n\n"NONE);
    s32Ret = PDT_STATEMNG_CreateHFSMInstance();
    PDT_STATEMNG_CHECK_RET(s32Ret,HI_PDT_STATEMNG_EINTER,"HFSM instance create");
    /** init all States */
    MLOGI(RED"PDT_STATEMNG_InitStates\n\n"NONE);
    ...
    //by eason HI_PDT_WORKMODE_E enWorkmode = HI_PDT_WORKMODE_NORM_REC;
...
//#ifdef CONFIG_PQT_SUPPORT_ON
    s32Ret |= HI_EVTHUB_Register(HI_EVENT_STATEMNG_PQDEBUG);
    s32Ret |= HI_EVTHUB_Register(HI_EVENT_STATEMNG_SCENE_AUTO);
//#endif
