...
#define PDT_PARAM_FLASH_ADDR     (0xC0000)
#define PDT_PARAM_BAK_FLASH_ADDR (0xD0000)
...
static HI_VOID PDT_PARAM_Save(HI_VOID *pParam)
{
    ...
    MLOGI("save to PDT_PARAM_Save2Flash\n");
...
HI_VOID PDT_PARAM_SetSaveFlg(HI_VOID)
{
    ...
    PDT_PARAM_Save(&s_stPARAMSaveTskCtx);
}
...
HI_S32 HI_PDT_PARAM_Init(HI_VOID)
{
    ...
    printf("%s(%d)  PDT_PARAM_PartInfoInit \r\n",__func__,__LINE__);
    ...
    /* Load Param Data */
    printf("%s(%d)  PDT_PARAM_LoadParam \r\n",__func__,__LINE__);
    PDT_PARAM_LoadParam();
#endif
    ...
    if ((s_stPARAMCtx.pstCfg->stHead.u32MagicStart) != PDT_PARAM_MAGIC_START
        ...
        MLOGE("\n Error!!! param can't resume 5!!! Please check the param data\n");
...
*/
    ...
    printf("%s(%d)  s_stPARAMCtx.pstCfg->stDevMngCfg.u8pqenb =%d\r\n",__func__,__LINE__,s_stPARAMCtx.pstCfg->stDevMngCfg.u8pqenb);
    printf("%s(%d)  s_stPARAMCtx.pstCfg->stDevMngCfg.bBootSoundEnable =%d\r\n",__func__,__LINE__,s_stPARAMCtx.pstCfg->stDevMngCfg.bBootSoundEnable);
...
{
    printf("%s(%d)  s_stPARAMCtx.bInit =%d \r\n",__func__,__LINE__,s_stPARAMCtx.bInit);
