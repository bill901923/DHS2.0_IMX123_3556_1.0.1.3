...
int smartlist_strings_eq( smartlist_t *sl1, smartlist_t *sl2){
    if(sl1==NULL)
        return sl2==NULL;
    if(sl2==NULL)
        return 0;
    if(smartlist_len(sl1)!=smartlist_len(sl2))
        return 0;
    SMARTLIST_FOREACH(sl1, char *,cp1,{char *cp2=smartlist_get(sl2,cp1_sl_idx);
        if(strcmp(cp1,cp2))
            return 0;
    });
    return 1;
...
int smartlist_ints_eq( smartlist_t *sl1, smartlist_t *sl2){
    if(sl1==NULL)
        return sl2==NULL;
    if(sl2==NULL)
        return 0;
    ...
    SMARTLIST_FOREACH(sl1,int * ,cp1,{int *cp2=smartlist_get(sl2,cp1_sl_idx);
        if(*cp1!=*cp2)
            return 0;
    });
    return 1;
