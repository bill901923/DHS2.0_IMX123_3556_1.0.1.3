...
HI_S32 PDT_SCENE_LoadStaticAE(const HI_CHAR *pszIniModule, HI_PDT_SCENE_STATIC_AE_S* pstStaticAe)
{
    ...
    snprintf(aszIniNodeName, PDT_SCENE_INIPARAM_NODE_NAME_LEN, "static_ae:Used");/*Used*/
    s32Ret = HI_CONFACCESS_GetInt(PDT_SCENE_INIPARAM, pszIniModule, aszIniNodeName, 0, (HI_S32*)&pstStaticAe->used);
    PDT_SCENE_INIPARAM_CHECK_LOAD_RESULT(s32Ret, aszIniNodeName);
...
HI_S32 PDT_SCENE_LoadStaticAWB(const HI_CHAR *pszIniModule, HI_PDT_SCENE_STATIC_AWB_S *pstStaticAWB)
{
    ...
    snprintf(aszIniNodeName, PDT_SCENE_INIPARAM_NODE_NAME_LEN, "static_awb:Used");/*Used*/
    s32Ret = HI_CONFACCESS_GetInt(PDT_SCENE_INIPARAM, pszIniModule, aszIniNodeName, 0, (HI_S32*)&pstStaticAWB->used);
    PDT_SCENE_INIPARAM_CHECK_LOAD_RESULT(s32Ret, aszIniNodeName);
...
HI_S32 PDT_SCENE_LoadStaticSharpen(const HI_CHAR *pszIniModule, HI_PDT_SCENE_STATIC_SHARPEN_S* pstStaticSharpen)
{
    ...
    /*AutoGGain*/
    snprintf(aszIniNodeName, PDT_SCENE_INIPARAM_NODE_NAME_LEN, "static_sharpen:AutoGGain");
    s32Ret = HI_CONFACCESS_GetString(PDT_SCENE_INIPARAM, pszIniModule, aszIniNodeName, NULL, &pszString);
    PDT_SCENE_INIPARAM_CHECK_LOAD_RESULT(s32Ret, aszIniNodeName);
    if (HI_NULL != pszString)
    {
...
HI_S32 PDT_SCENE_LoadDynamicClut(const HI_CHAR *pszIniModule, HI_PDT_SCENE_DYNAMIC_CLUT_S* pstDynamicClut)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        MLOGD("pstDynamicClut->au32ISOLevel[%d] =%d\n",u32IdxM,pstDynamicClut->au32ISOLevel[u32IdxM]);
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 PDT_SCENE_LoadDynamicDrc(const HI_CHAR *pszIniModule, HI_PDT_SCENE_DYNAMIC_DRC_S* pstDynamicDrc)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        MLOGD("pstDynamicDrc->au32ISOLevel[%d] =%d\n",u32IdxM,pstDynamicDrc->au32ISOLevel[u32IdxM]);
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 PDT_SCENE_LoadDynamicCAC(const HI_CHAR *pszIniModule, HI_PDT_SCENE_DYNAMIC_CAC_S* pstDynamicCAC)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        MLOGD("pstDynamicCAC->au32ISOLevel[%d] =%d\n",u32IdxM,pstDynamicCAC->au32ISOLevel[u32IdxM]);
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 PDT_SCENE_LoadDynamicBlackLevel(const HI_CHAR *pszIniModule, HI_PDT_SCENE_DYNAMIC_BLACKLEVEL_S* pstDynamicBlackLevel)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        MLOGD("pstDynamicBlackLevel->au32ISOLevel[%d] =%d\n",u32IdxM,pstDynamicBlackLevel->au32ISOLevel[u32IdxM]);
        }
        free(pszString);
        pszString = HI_NULL;
    }
