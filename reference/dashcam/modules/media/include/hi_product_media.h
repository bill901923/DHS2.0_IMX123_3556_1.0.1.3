 ...
 * @param[in] videoOutCfg : video out configure
 * @return    0 success,non-zero error code.
 * @exception None
 * @author    HiMobileCam Reference Develop Team
 * @date      2017/12/11
...
/**
 * @brief     Give a suggestion whether need to stop Disp When in Disp Restart situation
 * @return    0 success,non-zero error code.
 * @exception None
 * @author    HiMobileCam Reference Develop Team
 * @date      2017/12/11
...
/**
 * @brief     Give a suggestion whether need to stop Audio&AudioOut
 * @param[in] mediaCfg : media configure
 * @param[out] audioNeedReset : audio need reset
 * @param[out] audiooutNeedReset : audioout need reset
 * @return    0 success,non-zero error code.
 * @exception None
 * @author    HiMobileCam Reference Develop Team
 * @date      2017/12/11
 ...
 * @date      2017/12/11
 */
HI_S32 HI_PDT_MEDIA_VideoRebuild(const HI_PDT_MEDIA_CFG_S* pstMediaCfg);
