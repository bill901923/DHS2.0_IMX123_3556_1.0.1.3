...
HI_S32 HI_HAL_GSENSOR_Init(const HI_HAL_GSENSOR_CFG_S* pstCfg)
{
...
#if defined(HI3556AV100) || defined(HI3519AV100)
#ifdef BOARD_DEMB
    s32Ret = HI_insmod(HI_APPFS_KOMOD_PATH"/sc_7a20.ko","I2C_NUM=4");
    if(HI_SUCCESS != s32Ret)
    {
        MLOGE("insmod sc7a20: failed, errno(%d)\n", errno);
    ...
    s32Ret = HI_insmod(HI_APPFS_KOMOD_PATH"/sc_7a20.ko","I2C_NUM=7");
    if(HI_SUCCESS != s32Ret)
    {
        MLOGE("insmod sc7a20: failed, errno(%d)\n", errno);
        return HI_HAL_EINTER;
    ...
    s32Ret = HI_insmod(HI_APPFS_KOMOD_PATH"/sc_7a20.ko","I2C_NUM=7 LEVEL=1");
    if(HI_SUCCESS != s32Ret)
    {
        MLOGE("insmod sc7a20: failed, errno(%d)\n", errno);
        return HI_HAL_EINTER;
...
#ifndef __LITEOS__
    s32Ret = HI_rmmod(HI_APPFS_KOMOD_PATH"/sc_7a20.ko");
    if (HI_SUCCESS != s32Ret)
    {
