...
#define HI_HAL_TIMEOUT           HI_APPCOMM_ERR_ID(HI_APP_MOD_HAL,HI_ERRNO_CUSTOM_BOTTOM+6)/* timeout error */
#define HI_HAL_EAGAIN            HI_APPCOMM_ERR_ID(HI_APP_MOD_HAL,HI_ERRNO_CUSTOM_BOTTOM+7)/* Call is interrupted */
