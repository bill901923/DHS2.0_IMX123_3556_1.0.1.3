...
//HI_S32 HAL_WIFI_HAL_UpdateStaConfig(HI_CHAR *ifname,  const HI_HAL_WIFI_STAMODE_CFG_S *pstApCfg, const HI_CHAR *pszConfigFile);
HI_S32 HAL_WIFI_STA_Start(HI_CHAR *ifname,const HI_HAL_WIFI_STAMODE_CFG_S* pstApCfg);
