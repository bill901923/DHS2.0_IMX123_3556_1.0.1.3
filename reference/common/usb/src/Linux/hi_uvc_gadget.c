                        ...
                        HI_UVC_STREAM_FORMAT_E enFormat, HI_U32 u32FrameIdx)
{
    ...
    {
        case V4L2_PIX_FMT_YUV420:
            pstCtrl->dwMaxVideoFrameSize = pstFrameInfo->u32Width * pstFrameInfo->u32Height * 3 / 2;
            break;
        case V4L2_PIX_FMT_MJPEG:
        case V4L2_PIX_FMT_H264:
...
static HI_VOID UVC_EventProcData(UVC_DEVICE_CTX_S* pstCtx, struct uvc_request_data* pstReqData)
{
    ...
    {
        case V4L2_PIX_FMT_YUV420:
            stTargetCtrl->dwMaxVideoFrameSize = pstFrameInfo->u32Width * pstFrameInfo->u32Height * 3 / 2;
            break;
        case V4L2_PIX_FMT_MJPEG:
        case V4L2_PIX_FMT_H264:
