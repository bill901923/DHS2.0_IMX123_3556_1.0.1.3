...
#define HI_UPGRADE_EPKT_OVERSIZE    HI_APPCOMM_ERR_ID(HI_APP_MOD_UPGRADE, HI_EFULL)          /* package oversize */
#define HI_UPGRADE_EIMAGE_OVERSIZE    HI_APPCOMM_ERR_ID(HI_APP_MOD_UPGRADE, HI_EOVER)           /* partition image oversize*/
...
#define HI_EVENT_UPGRADE_PROGRESS HI_APPCOMM_EVENT_ID(HI_APP_MOD_UPGRADE, 4)
