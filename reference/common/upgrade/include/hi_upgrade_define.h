...
enum {UPGRADE_IMAGES_BY_UBOOT=0, UPGRADE_IMAGES_BY_APP};
/** upgrade packet head */
typedef struct hiUPGRADE_PKT_HEAD_S
{
    ...
    HI_U8   compress;      /**<packet data compress or not */
    HI_U8   pktType;      /* 0:u-boot write MTD, 1:linux write MTD, but appfs by remove file; 2:linux write all MTD */
    HI_U8   reserved0;    /* RFU */
    HI_U8   reserved1;    /* RFU */
