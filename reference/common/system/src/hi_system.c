...
HI_BOOL HI_SYSTEM_WaitSharefsReady(HI_S32 s32Timeout_s)
{
    ...
    while(1)
    {
        s32Ret = HI_MSG_SendSync(0,MSG_SYSTEM_GET_SHAREFS_CONNECTED_STATE, NULL, 0,
...
HI_S32 HI_SYSTEM_SetDateTime(const HI_SYSTEM_TM_S* pstDateTime)
{
    ...
    HI_MSG_SendASync(0,MSG_SYSTEM_SET_DATETIME, pstDateTime, sizeof(HI_SYSTEM_TM_S), NULL);
#endif
