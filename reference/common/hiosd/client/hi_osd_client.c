...
HI_S32 HI_OSD_SetAttr(HI_S32 s32OsdIdx, const HI_OSD_ATTR_S* pstAttr)
{
    ...
    return HI_MSG_SendSync(0,s32MsgID, pstAttr, sizeof(HI_OSD_ATTR_S), &stPrivData, NULL, 0);
}
...
HI_S32 HI_OSD_GetAttr(HI_S32 s32OsdIdx, HI_OSD_ATTR_S* pstAttr)
{
    ...
    stPrivData.as32PrivData[1]=s32OsdIdx;
    return HI_MSG_SendSync(0,s32MsgID, NULL, 0, &stPrivData, pstAttr, sizeof(HI_OSD_ATTR_S));
}
...
HI_S32 HI_OSD_Start(HI_S32 s32OsdIdx)
{
    ...
    stPrivData.as32PrivData[1]=s32OsdIdx;
    return HI_MSG_SendSync(0,s32MsgID, NULL, 0, &stPrivData, NULL, 0);
}
...
HI_S32 HI_OSD_Batch(HI_S32 s32Batch, HI_BOOL bShow)
{
    ...
    return HI_MSG_SendASync(0,s32MsgID, NULL, 0, &stPrivData);
}
