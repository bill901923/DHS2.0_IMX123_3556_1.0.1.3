...
typedef HI_S32 (*HI_FILEMNG_REPAIR_ADD_FILE_NAME_CALLBACK_FN_PTR)(const HI_CHAR *filePath, HI_VOID *argv);

/** filemng callback: add repair file name to file list cfg */
typedef HI_S32 (*HI_FILEMNG_REPAIR_GET_FILE_NAME_CALLBACK_FN_PTR)(HI_U32 fileIndex,
                                                                  HI_CHAR *filePath,
                                                                  HI_U32 maxFilePathLen,
                                                                  HI_VOID *argv);

/** filemng callback: add repair file name to file list cfg */
typedef HI_S32 (*HI_FILEMNG_REPAIR_GET_FILE_CNT_CALLBACK_FN_PTR)(HI_U32 *repairFileListCnt, HI_VOID *argv);

/** struct define */
/** define media operating function struct of record manager */
typedef struct hiFILEMNG_REPAIR_USER_OPERATION_S {
    HI_FILEMNG_REPAIR_ADD_FILE_NAME_CALLBACK_FN_PTR addRepairFileName; /**<Add repair file name to user */
    HI_FILEMNG_REPAIR_GET_FILE_NAME_CALLBACK_FN_PTR getRepairFileName; /**<Get repair file name from user */
    HI_FILEMNG_REPAIR_GET_FILE_CNT_CALLBACK_FN_PTR getRepairFileCnt;   /**<Get repair file count from user */
    HI_VOID *argv;
} HI_FILEMNG_REPAIR_OPERATION_S;
...
typedef struct hiFILEMNG_REPAIR_CFG_S {
    ...
    HI_FILEMNG_REPAIR_OPERATION_S operation; /**<Add/Get repair name callback */
#else
